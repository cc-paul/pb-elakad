...
<html>
	...
	<body class="hold-transition skin-black-light fixed sidebar-mini">
				...
				<section class="content col-md-6 col-xs-12">
					<div class="nav-tabs-custom">
						<ul class="nav nav-tabs">
							<li class="active"><a href="#admin" data-toggle="tab" aria-expanded="true" class="cust-label">Type of Services</a></li>
								...
								<div class="row">
									<div class="col-md-6 col-xs-12">
										<div class="form-group">
											<input id="txtSearchService" class="form-control input-sm cust-label" type="text" placeholder="Search services here...">
										</div>
									</div>
									<div class="col-md-3 col-xs-6">
										<div class="form-group">
											<button id="btnAddService" type="button" class="btn btn-block btn-default btn-sm cust-textbox">
									...
									<div class="col-md-3 col-xs-6">
										<div class="form-group">
											<button id="btnExportService" type="button" class="btn btn-block btn-success btn-sm cust-textbox">
								...
								<div class="row">
									<div class="col-md-12 col-sm-12">
										<div class="table-container">
											<table id="tblService" name="tblService" class="table table-bordered table-hover cust-label" style="width: 100% !important;">
												<thead>
													<tr>
														<th>Service</th>
														<th>Status</th>
		...
		<!-- Modal Name  -->
		<div class="modal fade" id="mdAddService" name="mdAddService">
			<div class="modal-dialog modal-semismall">
				<div class="box box-default">
					<div class="box-header with-border">
						<label class="cust-label">Service Form</label>
					...
					<div class="box-body">
						<div class="row">
							<div class="col-md-12 col-sm-12">
								<div class="form-group">
									<label class="cust-label">Name of Service</label>
									<label class="cust-label text-danger">*</label>
									<input type="text" class="form-control cust-label cust-textbox" id="txtService" name="txtService" placeholder="Enter Name of Service">
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12 col-sm-12">
								<label style="display: inline-block">
									<input id="chkActiveService" style="vertical-align: middle; margin-top: -4px;" type="checkbox"/>
									<label for="chkActiveService" style="vertical-align: middle" class="cust-label">&nbsp;&nbsp;Set as Active</label>
								</label>
							</div>
						</div>
					</div>
					<div class="box-footer">
						<div class="row">
							...
							<div class="col-md-6 col-xs-12">
								<button id="btnSaveService" type="button" class="btn btn-block btn-default btn-sm cust-textbox">
		...
		<script src="../program_assets/js/web_functions/services.js?random=<?php echo uniqid(); ?>"></script>

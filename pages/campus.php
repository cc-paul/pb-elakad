...
<html>
	...
	<body class="hold-transition skin-black-light fixed sidebar-mini">
		...
		<div class="wrapper">
			...
			<div class="content-wrapper" style="min-height:1500px !important; height:1500px !important;">
				...
				<section class="content col-md-12 col-sm-12">
					...
					<div class="box box-default">
						<div class="box-header with-border">
							<p class="box-title">Map Overview and Dashboard</p>
						</div>
						<div class="box-body">
							<div class="row">
								<div class="col-md-12">
		...
		<script src="../program_assets/js/web_functions/campus.js?random=<?php echo uniqid(); ?>"></script>

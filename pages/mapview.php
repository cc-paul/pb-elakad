...
<html>
	...
	<body class="hold-transition skin-black-light fixed sidebar-mini">
				...
				<section class="content col-md-12 col-xs-12">
					<div class="nav-tabs-custom">
						<ul class="nav nav-tabs">
							<li class="active"><a href="#admin" data-toggle="tab" aria-expanded="true" class="cust-label">Building Masterfile</a></li>
								...
								<div class="row">
									<div class="col-md-6 col-xs-12">
										<div class="form-group">
											<input id="txtSearchBuilding" class="form-control input-sm cust-label" type="text" placeholder="Search building here..." autocomplete="off">
										</div>
									</div>
									<div class="col-md-2 col-xs-12">
										<div class="form-group">
											<button id="btnAddBuilding" type="button" class="btn btn-block btn-default btn-sm cust-textbox">
									...
									<div class="col-md-2 col-xs-12">
										<div class="form-group">
											<button id="btnExportBuilding" type="button" class="btn btn-block btn-success btn-sm cust-textbox">
									...
									<div class="col-md-2 col-xs-12">
										<div class="form-group">
											<button id="btnCopy" type="button" class="btn btn-block btn-default btn-sm cust-textbox">
										...
										<div class="row">
											<div class="col-md-12">
												<div class="table-container">
													<table id="tblBuilding" name="tblBuilding" class="table table-bordered table-hover cust-label" style="width: 100% !important;">
														<thead>
															<tr>
																<th>Building Name</th>
																<th>Lat,Long</th>
		...
		<!-- Modal Name  -->
		<div class="modal fade" id="mdMap" name="mdMap">
			<div class="modal-dialog modal-md">
				<div class="box box-default">
					<div class="box-header with-border">
						<label class="cust-label">Building Form</label>
					...
					<div class="box-body">
							...
							<div class="col-md-12">
								<div class="callout">
									<p class="cust-label">
										...
										&nbsp;&nbsp;
										To paste the Lat and Long go to map click anywhere then click copy and paste it here
									</p>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<label class="cust-label">Building Name</label>
									<label class="cust-label text-danger">*</label>
									<input type="text" class="form-control cust-label cust-textbox" id="txtBuildingName" name="txtBuildingName" placeholder="Enter Building Name">
								</div>
							</div>
							<div class="col-md-6 col-sm-12">
								<label class="cust-label">Latitude Longitude</label>
								<label class="cust-label text-danger">*</label>
								<div class="input-group">
									<input id="txtLatLong" name="txtLatLong" type="text" class="form-control cust-label cust-textbox" placeholder="Enter Latitude Longitude" disabled>
									<span id="btnPasteLatLong" class="input-group-addon" style="cursor: pointer;" style="visibility:hidden"><i class="fa fa-paste"></i></span>
								</div>
							</div>
						</div>
						<div class="row">
						...
						<div class="row" style="visibility:hidden; height:0px;">
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<label class="cust-label">Nearest Distance Indicator (Meters)</label>
									<label class="cust-label text-danger">*</label>
									<input id="txtNdki" name="txtNdki" type="number" class="form-control cust-label cust-textbox" id="txtFirstName" name="txtFirstName" placeholder="Enter Nearest Distance Indicator (Meters)" value="1">
								</div>
							</div>
						</div>
					</div>
					<div class="box-footer">
						<div class="row">
							...
							<div class="col-md-4 col-xs-6">
								<button id="btnReset" type="button" class="btn btn-block btn-default btn-sm cust-textbox" style="display: none;">
							...
							<div class="col-md-4 col-xs-6">
								<button id="btnSaveMap" type="button" class="btn btn-block btn-default btn-sm cust-textbox">
		...
		<script src="../program_assets/js/web_functions/mapview.js?random=<?php echo uniqid(); ?>"></script>

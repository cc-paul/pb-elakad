...
<html>
	...
	<body class="hold-transition skin-black-light fixed sidebar-mini">
				...
				<section class="content col-md-10 col-xs-12">
					<div class="nav-tabs-custom">
						...
						<div class="tab-content">
							...
							<div class="tab-pane" id="freelancer">
								<div class="row">
									<div class="col-md-10 col-xs-12">
										<div class="form-group">
											<input id="txtSearchFreelancer" class="form-control input-sm cust-label" type="text" placeholder="Search freelancer here...">
										</div>
									</div>
									<!--<div class="col-md-2 col-xs-6">
										<div class="form-group">
									...
									<div class="col-md-2 col-xs-6">
										<div class="form-group">
											<button id="btnExportFreelancer" type="button" class="btn btn-block btn-success btn-sm cust-textbox">
												<i class="fa fa-file-excel-o"></i>
												&nbsp;
												Export to Excel
											</button>
								...
								<div class="row">
									<div class="col-md-12 col-sm-12">
										<div class="table-container">
											<table id="tblFreelancer" name="tblFreelancer" class="table table-bordered table-hover cust-label" style="width: 100% !important;">
												<thead>
													<tr>
														<th>Full Name</th>
														<th>Mobile Number</th>
					...
					<div class="box-body">
						...
						<div class="row">
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									<label class="cust-label">School ID</label>
		...
		<!-- Modal Name  -->
		<div class="modal fade" id="mdApproval" name="mdApproval">
			<div class="modal-dialog modal-md">
				<div class="box box-default">
					<div class="box-header with-border">
						<label class="cust-label">Freelancer Details</label>
						<button type="submit" class="btn btn-default btn-xs pull-right" data-dismiss="modal"><i class="fa fa-close"></i>
						</button>
					</div>
					<div class="box-body">
						<div class="row">
							<div class="col-md-4 col-xs-12">
								...
								<span id="spFullName" class="cust-label">{{ Full Name }}</span>
							</div>
							<div class="col-md-3 col-xs-12">
								<label class="cust-label">Mobile: </label>
								<span id="spMobile" class="cust-label">{{ Mobile }}</span>
							</div>
							<div class="col-md-5 col-xs-12 pull-right">
								<label class="cust-label">Email: </label>
								<span id="spEmail" class="cust-label">{{ Email }}</span>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
								<label class="cust-label">Address: </label>
								<span id="spAddress" class="cust-label">{{ Address }}</span>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
								<label class="cust-label">Services Offered: </label>
								<span id="spServicesOffered" class="cust-label">{{ Services Offered }}</span>
							</div>
						</div>
						<br>
					...
					<div class="box-footer">
						<div class="row">
							<div id="dvApprove" class="col-md-4 col-xs-12">
								<button id="btnApprove" type="button" class="btn btn-block btn-success btn-sm cust-textbox">
									<i class="fa fa-check"></i>
									&nbsp;
									Approve Account
								</button>
							</div>
							<div id="dvReject" class="col-md-4 col-xs-12">
								<button id="btnReject" type="button" class="btn btn-block btn-warning btn-sm cust-textbox">
									<i class="fa fa-times"></i>
									&nbsp;
									Reject Request
								</button>
								<button id="btnCancelRequest" type="button" class="btn btn-block btn-warning btn-sm cust-textbox" style="margin-top: 0px;">
									<i class="fa fa-times"></i>
									&nbsp;
									Cancel Request
								</button>
							</div>
							<div id="dvBan" class="col-md-4 col-xs-12">
								<button id="btnBan" type="button" class="btn btn-block btn-danger btn-sm cust-textbox">
